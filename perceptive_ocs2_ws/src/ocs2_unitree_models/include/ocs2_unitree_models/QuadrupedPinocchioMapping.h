 ...
 * @LastEditors: NaCl
 * @LastEditTime: 2024-04-08 20:57:06
 * @FilePath: /perceptive_ocs2_ws/src/ocs2_unitree_models/include/ocs2_unitree_models/QuadrupedPinocchioMapping.h
 * @Description:
 *
 */
#pragma once
...
namespace unitree
{
  ...
  public:
    ...
    switched_model::joint_coordinate_t getOcs2JointVector(const switched_model::joint_coordinate_t &jointPositions) const;

    switched_model::joint_coordinate_ad_t getOcs2JointVector(const switched_model::joint_coordinate_ad_t &jointPositions) const;

    size_t getPinocchioFootIndex(size_t ocs2FootIdx) const { return mapFeetOrderOcs2ToPinocchio_[ocs2FootIdx]; }
    size_t getOcs2FootIndex(size_t PinocchioFootIdx) const { return mapFeetOrderPinocchioToOcs2_[PinocchioFootIdx]; }
