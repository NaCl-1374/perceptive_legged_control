...
#include "ocs2_unitree_models/DynamicsHelpers.h"
...
template class unitree::tpl::QuadrupedCom<ocs2::scalar_t>;
template class unitree::tpl::QuadrupedCom<ocs2::ad_scalar_t>;
