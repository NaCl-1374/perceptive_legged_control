...
class PerceptiveLeggedInterface : public legged::LeggedInterface {
 public:
  ...
  std::tuple<bool, bool, scalar_t, RelaxedBarrierPenalty::Config, RelaxedBarrierPenalty::Config> loadFootPlacementSettings(const std::string& taskFile, bool verbose);
  std::tuple<bool, bool, RelaxedBarrierPenalty::Config, RelaxedBarrierPenalty::Config> loadCollisionSettings(const std::string& taskFile, bool verbose);
  std::tuple<bool, scalar_t, RelaxedBarrierPenalty::Config, RelaxedBarrierPenalty::Config> loadSwingFootPlacementSettings(const std::string& taskFile, bool verbose);
