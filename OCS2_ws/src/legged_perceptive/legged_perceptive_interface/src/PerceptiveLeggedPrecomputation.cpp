 ...
 * @Date: 2024-03-20 20:10:55
 * @LastEditors: error: error: git config user.name & please set dead value or install git && error: git config user.email & please set dead value or install git & please set dead value or install git
 * @LastEditTime: 2024-03-28 00:30:15
 * @FilePath: /leg_perceptive_ws/src/legged_perceptive/legged_perceptive_interface/src/PerceptiveLeggedPrecomputation.cpp
...
std::pair<matrix_t, vector_t> PerceptiveLeggedPrecomputation::getPolygonConstraint(
  ...
  for (size_t i = 0; i < numVertices; i++) {
    ...
    polytopeB(i) = point_a.y() * point_b.x() - point_a.x() * point_b.y()-0.04;
