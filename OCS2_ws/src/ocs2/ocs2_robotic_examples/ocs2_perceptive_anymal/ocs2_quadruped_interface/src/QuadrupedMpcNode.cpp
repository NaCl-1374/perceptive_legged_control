...
namespace switched_model {
    ...
    void quadrupedMpcNode(ros::NodeHandle &nodeHandle, const QuadrupedInterface &quadrupedInterface, std::unique_ptr<ocs2::MPC_BASE> mpcPtr, const std::string &robotname)
    {
        const std::string robotName = robotname;
