 ...
 * @LastEditors: NaCl
 * @LastEditTime: 2024-04-12 19:07:48
 * @FilePath: /OCS2_ws/src/ocs2/ocs2_robotic_examples/ocs2_perceptive_anymal/ocs2_quadruped_interface/src/SwingPlanningVisualizer.cpp
 * @Description: 
 * 
 */
//
...
SwingPlanningVisualizer::SwingPlanningVisualizer(const SwingTrajectoryPlanner& swingTrajectoryPlanner, ros::NodeHandle& nodeHandle,const std::string frameId )
    : swingTrajectoryPlannerPtr_(&swingTrajectoryPlanner),frameId_(frameId) {
