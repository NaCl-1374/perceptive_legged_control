 ...
 * @LastEditors: NaCl
 * @LastEditTime: 2024-04-06 19:11:08
 * @FilePath: /OCS2_ws/src/ocs2/ocs2_robotic_examples/ocs2_perceptive_anymal/ocs2_switched_model_interface/src/logic/GaitReceiver.cpp
 * @Description: 
 * 
 */
//
...
void GaitReceiver::mpcModeSequenceCallback(const ocs2_msgs::mode_schedule::ConstPtr& msg) {
  ...
  ROS_INFO_STREAM("_mpc_mode_schedule command node is receive.");
  ROS_INFO_STREAM("modeSequenceTemplate is receive."<<modeSequenceTemplate);
  {
    std::lock_guard<std::mutex> lock(receivedGaitMutex_);
